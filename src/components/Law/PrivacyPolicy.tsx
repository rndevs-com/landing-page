...
const PrivacyPolicy = () => {
  return (
    <>
      <p className="text-white md:text-base text-sm font-light">Dzień dobry!</p>
      <p className="text-white md:text-base text-sm font-light">
        W tym dokumencie znajdziesz zasady przetwarzania danych osobowych oraz
      ...
      <p>
        Administratorem strony jest Kamil Czech prowadzący działalność
        gospodarczą pod firmą MZ studiocode KAMIL CZECH ul. Spadochroniarzy 104
        Mszana Dolna 34730, wpisanego do Centralnej Ewidencji i Informacji o
        Działalności Gospodarczej, NIP 7372193430, REGON 363922267
      </p>
      <p>
      ...
      <p>
        ...
        związanych z ochroną prywatności.
      </p>
      <ol className="space-y-5">
        <li>
          Zapisując się do newslettera lub kontaktując się z nami, przekazujesz
        ...
        <li>
          ...
          podmiotom świadczącym usługi związane z przetwarzaniem danych
          osobowych.
        </li>
        <li>
          Korzystamy z narzędzi analitycznych Google Analytics, które zbierają
          informacje na temat Twoich odwiedzin strony, takie jak podstrony,
          które wyświetliłeś, czas, jaki spędziłeś na stronie czy przejścia
          pomiędzy poszczególnymi podstronami. W tym celu wykorzystywane są
          pliki cookies firmy Google LLC dotyczące usługi Google Analytics. W
          ramach mechanizmu do zarządzania ustawieniami plików cookies masz
          możliwość zadecydowania, czy w ramach usługi Google Analytics będziemy
      ...
      <h3 className="font-bold text-2xl">Dane osobowe</h3>
      <p>
        <strong>Administratorem</strong> Twoich danych osobowych w rozumieniu
        przepisów o ochronie danych osobowych jest Kamil Czech prowadzący
        działalność gospodarczą pod firmą MZ studiocode KAMIL CZECH ul.
        Spadochroniarzy 104, wpisanego do Centralnej Ewidencji i Informacji o
        Działalności Gospodarczej, NIP 7372193430, REGON 363922267 Mszana Dolna
        34730
      </p>
      <p>
        <strong>
      ...
      <h3 className="font-bold text-2xl">Uprawnienia</h3>
      <p>
      ...
      <p>
        ...
        przysługujące Ci w ramach tych operacji uprawnienia.
      </p>
      <p>
      ...
      <p>
        ...
        . Dołożyliśmy jednak wszelkich starań, by interesujące Cię informacje
      ...
      <p>
        <strong>Bezpieczeństwo</strong>. Gwarantujemy Ci poufność wszelkich
        przekazanych nam danych osobowych. Zapewniamy podjęcie wszelkich środków
        ...
        starannością i odpowiednio chronione przed dostępem do nich przez osoby
        do tego nieupoważnione.
      </p>
      <p>
        <strong>Wykaz powierzeń</strong>. Powierzamy przetwarzanie danych
        osobowych następującym podmiotom
      </p>
      <p>
        Sendinblue SAS – Politique de confidentialité 7 rue de Madrid, 75008
        Paryż, Francja – w celu korzystania z systemu mailingowego, w którym
      ...
      <h3 className="font-bold text-2xl">Cele i czynności przetwarzania</h3>
      <p>
        <strong>Newsletter</strong>. Jeżeli chcesz zapisać się do newslettera,
        musisz przekazać nam swój adres e-mail za pośrednictwem formularza
      ...
      <p>
        Dane przetwarzane są w ramach systemu mailingowego Sendinblue i
        przechowywane na serwerze zapewnianym przez Sendinblue SAS.
      </p>
      <p>
      ...
      <p>
        <strong>Kontakt e-mailowy</strong>. Kontaktując się z nami za
        pośrednictwem poczty elektronicznej, w tym również przesyłając zapytanie
        poprzez formularz kontaktowy, w sposób naturalny przekazujesz nam swój
        adres e-mail jako adres nadawcy wiadomości. Ponadto, w treści wiadomości
        możesz zawrzeć również inne dane osobowe.
      </p>
      <p>
      ...
      <p>
        <strong>Zgoda na cookies</strong>. Podczas pierwszej wizyty na stronie
        ...
        przeglądarki albo w ogóle usunąć pliki cookies. Pamiętaj jednak, że
        wyłączenie plików cookies może powodować trudności w korzystaniu ze
        strony, jak również z wielu innych stron internetowych, które stosują
        cookies.
      </p>
      <p>
        <strong>Cookies podmiotów trzecich</strong>. Nasza strona, podobnie jak
      ...
      <p>
        ...
        rodzaj systemu operacyjnego i przeglądarki internetowej wykorzystywanej
        do przeglądania strony, czas spędzony na stronie, odwiedzone podstrony
        etc. Korzystamy w tym zakresie z Google Analytics, co wiąże się z
        wykorzystaniem plików cookies firmy Google LLC. W ramach mechanizmu do
        zarządzania ustawieniami plików cookies masz możliwość zadecydowania,
        czy w ramach usługi Google Analytics będziemy mogli korzystać również z
        funkcji marketingowych, czy nie.
      </p>
      <p>
        <strong>Marketing</strong>. Korzystamy z narzędzi marketingowych, takich
        jak Facebook Pixel, by kierować do Ciebie reklamy. Wiążę się to z
        wykorzystywaniem plików cookies firmy Facebook. W ramach ustawień plików
        cookies możesz zadecydować, czy wyrażasz zgodę na korzystanie przez nas
        w Twoim przypadku z Pixela Facebooka, czy nie.
      </p>
      <h3 className="font-bold text-2xl">Logi serwera</h3>
      <p>
